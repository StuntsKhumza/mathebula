...
class sqlClass {
    ...
    private function query_read($q) {
        ...
        switch ($q) {
            ...
            case "searchProfile":
                    $query = "SELECT * FROM `users` WHERE `CARDNUMBER` LIKE = ? OR `IDNUMBER` LIKE  ?";
                break;
        }
    ...
    private function query_insert($q) {
        ...
        switch ($q) {
            ...
            case "addProduct_images":
                ...
                break;
        }//"SQLSTATE[42000]: Syntax error or access violation: 1064 You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near '?????)' at line 1Array(    [0] => 42000    [1] => 1064    [2] => You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near '?????)' at line 1)null"
